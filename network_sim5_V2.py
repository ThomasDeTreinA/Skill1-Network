...
class MissionSystem:
    ...
    def check_conditions(self, devices, connections, packets, sm=None, active_window=None, active_device=None, isp_inputs=None):
        ...
        if mission.type == "PLACE":
            ...
            if active_window == "ISP" and isp.inputs[1].text.strip() == "255.0.0.0":
                self.advance()
        elif mission.type == "L2_ISP_GW":
            if active_window == "ISP" and isp.inputs[2].text.strip() == "84.197.10.1":
                self.advance()
        elif mission.type == "L2_ISP_DNS1":
            if active_window == "ISP" and isp.inputs[3].text.strip() == "8.8.8.8":
                self.advance()
        elif mission.type == "L2_ISP_DNS2":
            if active_window == "ISP" and isp.inputs[4].text.strip() == "8.8.4.4":
                self.advance()
            ...
            if active_window == "ISP" and isp.inputs[0].text.strip() == "193.191.1.20":
                self.advance()
        elif mission.type == "L3_H1_ISP_SUB":
            if active_window == "ISP" and isp.inputs[1].text.strip() == "255.0.0.0":
                self.advance()
        elif mission.type == "L3_H1_ISP_GW":
            if active_window == "ISP" and isp.inputs[2].text.strip() == "193.191.0.1":
                self.advance()
